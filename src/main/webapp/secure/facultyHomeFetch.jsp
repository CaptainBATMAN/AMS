                            ...
                            <div class="navbar-collapse collapse" id="navbarNav">
                                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                                    <li class="nav-item active">
                                        <a class="nav-link"  style="color: #28a745 !important;" href="./facultyHomeFetch.jsp">Fetch</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="./facultyHomeUpdate.jsp">Update</a>
                                    </li>
                                    <li class="nav-item">
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <p class="font-weight-bolder">
                                                        Google Meet Code :
                                                        <input id="gmeetcode" class="input-sm form-control" placeholder="(Optional)" type="text"
